...
extern void DRV8311P_read_addr(uint8_t addr, uint16_t *p_Data);
extern void DRV8311P_read_multiple_addr(uint8_t base_addr, uint16_t *p_Data, size_t num_of_reg);
extern void DRV8311P_read_All_reg(st_drv8311p_t* p_drv8311p_address, st_drv8311p_t* p_drv8311p_reg_data);

extern void DRV8311P_write_addr(uint8_t addr, uint16_t *p_Data);
extern void DRV8311P_PWM_GEN(st_drv8311p_t* p_drv8311p_address, uint8_t ON_OFF);
extern void DRV8311P_update_PWM(st_drv8311p_t* p_drv8311p_address, uint16_t Period_12bit, uint16_t dtcA, uint16_t dtcB, uint16_t dtcC);

extern void DRV8311P_Init(st_drv8311p_t* p_drv8311p_address, st_drv8311p_t* p_drv8311p_reg_data);
...
//			DRV8311P_read_multiple_addr(drv8311p_address.DEV_STS1, (uint16_t*) &drv8311p_reg_data, 21);
	...
	{
		flag = 0;
		DRV8311P_update_PWM(&drv8311p_address, 2048, drv8311p_reg_data.PWMG_A_DUTY, drv8311p_reg_data.PWMG_B_DUTY, drv8311p_reg_data.PWMG_C_DUTY);
	}
	else if (flag == 7)
	{
		flag = 0;
